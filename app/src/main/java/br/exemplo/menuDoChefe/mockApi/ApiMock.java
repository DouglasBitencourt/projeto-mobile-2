...
public class ApiMock {
    ...
    private void carregarPosts() {
        ...
        posts.add(new Post(8L, "Prato: Tiramisu", "Uma tradicional sobremesa italiana feita com camadas de biscoitos embebidos em café, creme de mascarpone e cacau em pó. Uma combinação irresistível de sabores e texturas para encerrar a refeição com doçura.", "https://i.im.ge/2023/06/04/hbhWWm.tira.jpg", 14.99));
    }
